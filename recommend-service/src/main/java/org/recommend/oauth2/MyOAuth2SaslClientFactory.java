 ...
 */
//@Component
public class MyOAuth2SaslClientFactory implements SaslClientFactory {
  private static final Logger logger =
      Logger.getLogger(MyOAuth2SaslClientFactory.class.getName());
  ...
  public SaslClient createSaslClient(String[] mechanisms,
    ...
    return new MyOAuth2SaslClient((String) props.get(OAuth2PropKeys.OAUTH_TOKEN),
                                callbackHandler);
  }
